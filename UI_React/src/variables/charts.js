...
const multipleBarsChart = {
  data: {
    ...
    series: [
      [542, 443, 320, 780, 553, 453, 326, 434, 568, 610, 756, 895, 123, 456, 850, 345],
      [412, 243, 280, 580, 453, 353, 300, 364, 368, 410, 636, 695, 245, 789, 463, 456]
    ]
  },
  options: {
    seriesBarDistance: 10,
